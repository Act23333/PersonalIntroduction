        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          <ScrollReveal delay={0}>
            <GlassCard className="h-full">
              ...
              <h3 className="text-white font-semibold text-lg mb-2">教育背景</h3>
              <p className="text-gray-300 font-medium">{education.school}</p>
              <p className="text-gray-400 text-sm">{education.major}</p>
          ...
          <ScrollReveal delay={0.15}>
            <GlassCard className="h-full">
              ...
              <h3 className="text-white font-semibold text-lg mb-2">技能证书</h3>
          ...
          <ScrollReveal delay={0.3}>
            <GlassCard className="h-full">
              ...
              <h3 className="text-white font-semibold text-lg mb-2">求职方向</h3>
